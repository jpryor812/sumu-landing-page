    ...
    return(
        <div className = "bg-white rounded-3xl flex-1">
            <div className = "flex flex-col p-4">
                ...
                <div className = "bg-pink-300 h-6 px-20 rounded-full mx-auto">
                    <div className = "text-white text-md font-semibold text-center">
                        <p>Join</p>
                    </div>
                </div>
                <div className = "text-black text-xs pt-2">
                <p>Your support means the world to me and allows me to spend more time making great music for you to listen to.</p>
                </div>
            </div>
        </div>
    )
