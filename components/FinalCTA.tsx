...
export default function FinalCTA (){
    return(
        <div className = "flex flex-col">
            ...
            <div className="relative w-[90px] h-[90px] md:w-[180px] md:h-[180px] lg:w-[220px] lg:h-[220px] mx-auto border-4 border-gray-500 rounded-full flex items-center justify-center">
                <div className="relative w-[80px] h-[80px] md:w-[170px] md:h-[170px] lg:w-[210px] lg:h-[210px] mx-auto border-2 border-black rounded-full flex items-center justify-center bg-black">
                    <Image
                        src="/Sumu-logo-vert.png"
                        alt="Sumu Logo"
                        width={200}
                        height={200}
                        className="logo-image absolute w-[70px] h-[70px] md:w-[160px] md:h-[160px] lg:w-[200px] lg:h-[200px]"  
                    />
                </div>
            </div>
                <div className="flex items-center justify-center bg-[#4040FF] text-white font-semibold py-2 sm:py-4 text-center text-sm sm:text-md md:text-3xl rounded-3xl mx-auto"> {/* Added wrapper div */}
                    <WaitlistButton />
                </div>
                <div className="relative w-[90px] h-[90px] md:w-[180px] md:h-[180px] lg:w-[220px] lg:h-[220px] mx-auto border-4 border-gray-500 rounded-full flex items-center justify-center">
                <div className="relative w-[80px] h-[80px] md:w-[170px] md:h-[170px] lg:w-[210px] lg:h-[210px] mx-auto border-2 border-black rounded-full flex items-center justify-center bg-black">
