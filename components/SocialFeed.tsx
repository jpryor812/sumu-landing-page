...
export default function SocialFeed (){
    return (
        <div className = "gradient-bg border-white border-4 rounded-lg pb-6 px-12">
            <div className = "flex flex-col border-blue-100 border-r-2 border-l-2">
                <div className = "flex flex-row gap-6 p-4 align-center justify-center text-sm text-gray-100">
                    <p className="font-semibold border-b-2 border-pink-200 text-white">All</p>
                    <p>Art</p>
                    <p>Fashion</p>
                    <p>Finance</p>
                    <p>Gaming</p>
                ...
                <div className = "flex justify-center mx-auto w-10/12 bg-black border-gray-500 border-2 rounded-2xl p-2">
                    <div className= "flex flex-col">
                        ...
                        <div className ="text-md font-semibold text-blue-300 px-8 pb-2">
